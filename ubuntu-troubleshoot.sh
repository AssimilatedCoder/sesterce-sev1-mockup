...
echo "   sudo systemctl stop nullsector-calculator-api"
echo "   sudo pkill -f 'gunicorn.*calculator-api'"
echo ""

echo "5. Update Nginx configuration:"
echo "   sudo sed -i 's/listen 7777/listen 3025/g' /etc/nginx/sites-available/nullsector-dashboard"
echo "   sudo sed -i 's/listen \[::\]:7777/listen [::]:3025/g' /etc/nginx/sites-available/nullsector-dashboard"
echo ""
...
echo "   sudo grep -n '7777\|3025' /etc/systemd/system/nullsector-calculator-api.service"
echo ""

echo "8. Restart everything:"
echo "   sudo systemctl restart nginx"
echo "   sudo systemctl restart nullsector-calculator-api"
echo ""
