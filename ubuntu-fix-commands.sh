...
echo "grep -n 'listen' /etc/nginx/sites-available/sesterce-dashboard"
echo ""
...
echo "sudo sed -i 's/listen 3025/listen 3026/g' /etc/nginx/sites-available/sesterce-dashboard"
echo "sudo sed -i 's/listen \[::\]:3025/listen \[::\]:3026/g' /etc/nginx/sites-available/sesterce-dashboard"
